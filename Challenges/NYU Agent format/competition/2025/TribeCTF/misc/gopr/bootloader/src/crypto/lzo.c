...
#include <limits.h>
#include <stddef.h>
#if defined(LZO_CFG_USE_INTERNAL_LZODEFS)
...
#if !defined(LZO_VERSION) || (LZO_VERSION != 0x20a0)
#  error "version mismatch in LZO source files"
#endif
...
#if defined(__LZO_IN_LZO) || (LZO_CFG_FREESTANDING)
#elif 1
#  include <string.h>
#else
...
#if !defined(LZO_CFG_SKIP_LZO_PTR)
...
#endif
#if !defined(LZO_CFG_SKIP_LZO_UTIL)
...
#endif
#if !defined(LZO_CFG_SKIP_LZO_STRING)
#undef lzo_memcmp
#undef lzo_memcpy
#undef lzo_memmove
#undef lzo_memset
...
#undef LZOLIB_PUBLIC
#endif
#if !defined(LZO_CFG_SKIP_LZO_INIT)
...
#if !defined(LZO_CFG_SKIP_LZO1X_1_COMPRESS)
...
#if !defined(LZO_CFG_SKIP_LZO1X_DECOMPRESS)
...
#if !defined(LZO_CFG_SKIP_LZO1X_DECOMPRESS_SAFE)
